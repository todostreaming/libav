...
#define MPEGTS_OPTIONS \
    { "resync_size",   "Size limit for looking up a new sincronization.", offsetof(MpegTSContext, resync_size), AV_OPT_TYPE_INT,  { .i64 =  MAX_RESYNC_SIZE}, 0, INT_MAX,  AV_OPT_FLAG_DECODING_PARAM }
