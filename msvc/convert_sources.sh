#!/bin/bash
for file in ../libavfilter/af_{aformat,amix,anull,asyncts,channelmap,channelsplit,join,resample}.c \
            ../libavfilter/avfilter{,graph}.c \
            ../libavfilter/{asink_anullsink.c,asrc_anullsrc.c} \
            ../libavfilter/buffer{src,sink}.c \
            ../libavfilter/fifo.c \
            ../libavfilter/split.c \
            ../libavfilter/vf_{aspect,blackframe,boxblur,copy,crop,cropdetect,delogo,drawbox,fade,fieldorder,format,fps,gradfun,hflip,hqdn3d,lut,null,overlay,pad,pixdesctest,scale,select,setpts,settb,showinfo,slicify,transpose,unsharp,vflip,yadif}.c \
			...
			../libavformat/{hls,hlsproto,http,id3v1,idcin,idroq{dec,enc},iff,ilbc,img2{dec,enc},ingenientdec,ipmovie,iss,iv8,ivf{dec,enc},jvdec,latmenc,lmlm4,lxfdec}.c \
			...
			../libavformat/{rtmpproto,rtmphttp,rtpdec{,_amr,_asf,_g726,_h263,_h263_rfc2190,_h264,_ilbc,_latm,_mpeg4,_qcelp,_qdm2,_qt,_svq3,_vp8,_xiph},rtpenc,rtpproto,rtsp}.c \
			...
			../libavcodec/{dpcm,dpx{,enc},dsicinav,dv{,_profile,dec},dvbsub{,_parser,dec},dvdsub{_parser,dec,enc},dxa,dxtory,dxva2_{h264,mpeg2,vc1},eac3enc,ea{cmv,mad,tgq,tgv,tqi}}.c \
			../libavcodec/{escape124,ffv1,flac{_parser,dec,enc},flashsv,flashsvenc,flicvideo,flv{dec,enc},fraps,frwu,g722{dec,enc},g726,gif{,dec},gsm{_parser,dec},h261{_parser,dec,enc}}.c \
			...
			../libavcodec/{jpegls{dec,enc},jvdec,kgv1dec,kmvc,lagarith,latm_parser,lcldec,lclenc,ljpegenc,loco,mace,mdec,mimic,mjpeg{2jpeg_bsf,_parser,bdec,dec,enc},mlp{_parser,dec}}.c \
			...
			../libavcodec/{msrle,mss1,mss3,mss4,msvideo1,mxpegdec,nellymoser{dec,enc},nuv,options,pamenc,pcm-mpeg,pcm,pcx{,enc},pgssubdec,pictordec,pngdec,pngenc,pnm{_parser,dec,enc},prores{dec,enc}}.c \
			...
			../libavcodec/{tiertexseqv,tiff{,enc},tmv,truemotion{1,2},truespeech,tscc,tscc2,tta,twinvq,txd,ulti,utils,utvideo,v210{dec,enc,x},v410{dec,enc},vb,vble,vc1{,_parser,dec}}.c \
			...
			../libavcodec/{wnv1,ws-snd1,xan,xbmenc,xl,xsub{dec,enc},xwd{dec,enc},xxan,yop,zerocodec,zmbv,zmbvenc}.c \
