...
#define _BSD_SOURCE // for MAP_ANONYMOUS and getpagesize
...
#define BLOCK_ALIGN (32 /* sizeof(void *) * 2 */)
...
#if 0
# define PRINT_MSG(fmt, args...) av_log(NULL, AV_LOG_INFO, fmt, ## args)
# define ERROR_MSG(fmt, args...) av_log(NULL, AV_LOG_ERROR, fmt, ## args)
#else
