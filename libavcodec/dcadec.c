...
static void qmf_32_subbands(DCAContext *s, int chans, float samples_in[32][8],
                            ...
                            int *got_frame_ptr, AVPacket *avpkt)
{
    ...
    av_log(avctx, AV_LOG_DEBUG,
           "%s: stream_index %d, pos %"PRId64", frame index %u, sample index %u\n",
...
static const AVOption options[] = {
    ...
    { "disable_xll", "disable decoding of the XLL extension", offsetof(DCAContext, xll_disable), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, AV_OPT_FLAG_DECODING_PARAM|AV_OPT_FLAG_AUDIO_PARAM },
    { NULL },
};
