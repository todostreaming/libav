...
#if !defined(WIN32)
#define LOAD_PLUGIN_HEVC_DEFAULT LOAD_PLUGIN_HEVC_SW
#else
#define LOAD_PLUGIN_HEVC_DEFAULT LOAD_PLUGIN_HEVC_HW
#endif

static const AVOption options[] = {
    QSV_COMMON_OPTS

    { "load_plugin", "A user plugin to load in an internal session", OFFSET(load_plugin), AV_OPT_TYPE_INT, { .i64 = LOAD_PLUGIN_HEVC_DEFAULT }, LOAD_PLUGIN_NONE, LOAD_PLUGIN_HEVC_HW, VE, "load_plugin" },
