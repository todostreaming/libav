...
{                                                                             \
    ...
    vp8_ ## dir ## _loop_filter8_c(dstV, stride, fE, fI, hev_thresh);         \
                                                                              ...
                                                                              \
static void vp8_ ## dir ## _loop_filter8uv_inner_c(uint8_t *dstU, uint8_t *dstV, \
                                                   ptrdiff_t stride, int fE,  \
                                                   int fI, int hev_thresh)    \
{                                                                             \
...
static void put_vp8_epel ## SIZE ## _h ## HTAPS ## v ## VTAPS ## _c(uint8_t *dst, \
                                                                    ptrdiff_t dststride, \
                                                                    uint8_t *src, \
                                                                    ptrdiff_t srcstride, \
                                                                    int h,    \
...
{                                                                             \
    ...
    for (y = 0; y < h; y++) {                                                 \
        ...
        src += sstride;                                                       \
                                                                              ...
                                                                              \
static void put_vp8_bilinear ## SIZE ## _hv_c(uint8_t *dst, ptrdiff_t dstride, \
                                              uint8_t *src, ptrdiff_t sstride, \
                                              int h, int mx, int my)          \
{                                                                             \
    int a = 8 - mx, b = mx;                                                   \
