...
#define PEL_PROTOTYPE(name, D)                                                        \
    ...
    void ff_hevc_put_hevc_bi_ ## name ## _ ## D ## _sse4(uint8_t * _dst,              \
                                                         ...
                                                         intptr_t my,                 \
                                                         int width);                  \
    void ff_hevc_put_hevc_uni_ ## name ## _ ## D ## _sse4(uint8_t * _dst,             \
                                                          ptrdiff_t _dststride,       \
                                                          uint8_t * _src,             \
                                                          ptrdiff_t _srcstride,       \
                                                          int height,                 \
                                                          ...
                                                          intptr_t my,                \
                                                          int width);                 \
    void ff_hevc_put_hevc_uni_w_ ## name ## _ ## D ## _sse4(uint8_t * _dst,           \
                                                            ptrdiff_t _dststride,     \
                                                            uint8_t * _src,           \
                                                            ptrdiff_t _srcstride,     \
                                                            ...
                                                            int width);               \
    void ff_hevc_put_hevc_bi_w_ ## name ## _ ## D ## _sse4(uint8_t * _dst,            \
                                                           ptrdiff_t _dststride,      \
                                                           uint8_t * _src,            \
                                                           ptrdiff_t _srcstride,      \
                                                           int16_t * src2,            \
...
#define WEIGHTING_PROTOTYPE(width, bitd)                                                              \
    void ff_hevc_put_hevc_uni_w ## width ## _ ## bitd ## _sse4(uint8_t * dst,                         \
                                                               ptrdiff_t dststride,                   \
                                                               int16_t * _src, ptrdiff_t _srcstride,  \
                                                               int height, int denom,                 \
                                                               int _wx,                               \
                                                               int _ox);                              \
    void ff_hevc_put_hevc_bi_w ## width ## _ ## bitd ## _sse4(uint8_t * dst,                          \
                                                              ptrdiff_t dststride,                    \
                                                              int16_t * _src, ptrdiff_t _srcstride,   \
                                                              int16_t * _src2, ptrdiff_t _src2stride, \
                                                              int height, int denom,                  \
                                                              int _wx0, int _wx1, int _ox0,           \
                                                              int _ox1)
