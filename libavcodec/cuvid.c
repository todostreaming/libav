 ...
 * Copyright (C) 2016 Ruta Gadkari <rgadkari@nvidia.com>
 *
...
error:
    if (mapped_frame)
        CHECK_CU(cuvidUnmapVideoFrame(ctx->cudecoder, mapped_frame));
...
#if CONFIG_HEVC_CUVID_DECODER
CUVID_CODEC(hevc, HEVC)
#elif CONFIG_HEVC_CUVID_HWACCEL
CUVID_HWACCEL(hevc, HEVC)
#endif

#if CONFIG_MJPEG_CUVID_DECODER
CUVID_CODEC(mjpeg, MJPEG)
#elif CONFIG_MJPEG_CUVID_HWACCEL
CUVID_HWACCEL(mjpeg, MJPEG)
#endif

#if CONFIG_MPEG1_CUVID_DECODER
CUVID_CODEC(mpeg1, MPEG1VIDEO)
#elif CONFIG_MPEG1_CUVID_HWACCEL
CUVID_HWACCEL(mpeg1, MPEG1VIDEO)
#endif

#if CONFIG_MPEG2_CUVID_DECODER
CUVID_CODEC(mpeg2, MPEG2VIDEO)
#elif CONFIG_MPEG2_CUVID_HWACCEL
CUVID_HWACCEL(mpeg2, MPEG2VIDEO)
#endif

#if CONFIG_MPEG4_CUVID_DECODER
CUVID_CODEC(mpeg4, MPEG4)
#elif CONFIG_MPEG4_CUVID_HWACCEL
CUVID_HWACCEL(mpeg4, MPEG4)
#endif

#if CONFIG_VC1_CUVID_DECODER
CUVID_CODEC(vc1, VC1)
#elif CONFIG_VC1_CUVID_HWACCEL
CUVID_HWACCEL(vc1, VC1)
#endif

#if CONFIG_VP8_CUVID_DECODER
CUVID_CODEC(vp8, VP8)
#elif CONFIG_VP8_CUVID_HWACCEL
CUVID_HWACCEL(vp8, VP8)
#endif

#if CONFIG_VP9_CUVID_DECODER
CUVID_CODEC(vp9, VP9)
#elif CONFIG_VP9_CUVID_HWACCEL
CUVID_HWACCEL(vp9, VP9)
#endif
