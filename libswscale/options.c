...
static const AVOption options[] = {
    ...
    { "src_format",      "source format",                 OFFSET(srcFormat), AV_OPT_TYPE_INT,    { DEFAULT            }, 0,       PIX_FMT_NB - 1, VE },
    { "dst_format",      "destination format",            OFFSET(dstFormat), AV_OPT_TYPE_INT,    { DEFAULT            }, 0,       PIX_FMT_NB - 1, VE },
